...
def main():
    ...
    def redraw_window():
        ...
        lives_label = main_font.render(f"Lives: {lives}", 1, ("purple"))
        level_label = main_font.render(f"Level: {level}", 1, ("purple"))
...
def main_menu():
    ...
    while run:
        ...
        title_label = title_font.render(
            "Press the mouse to begin...", 1, "white")
